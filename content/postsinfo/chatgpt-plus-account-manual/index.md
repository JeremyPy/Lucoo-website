...
![ChatGPT 登录页面](image-03.png)

### 4. 获取邮箱验证码

在上图中点击继续，出现如下提示，此时需要去邮箱中获取验证码。

![邮箱验证码提示](image-04.png)
...
![登录完成等待跳转](image-09.png)

### 10. 确认账号状态

查看自己的账号为 Plus，一切正常，然后可以开始愉快的 AI 体验了！

![确认 Plus 状态](image-10.png)
