...
![创建令牌时选择 Claude 分组](relay-token-claude-group.png)
...
![令牌创建成功并复制 API Key](relay-token-done.png)
...
![选择 Claude 桌面端入口](image-1.png)

### 2. 添加自定义供应商

点击右上角加号，进入「添加新供应商」页面，选择「自定义配置」。

![添加自定义供应商](image-2.png)
