...
国内环境优先使用 `https://api.lucoo.net/v1` 作为 API 请求地址；如果跨境访问不稳定，可以改用 `https://apicc.lucoo.net/v1`。
...
| Base URL | 国内默认填 `https://api.lucoo.net/v1` |
...
3. Base URL 是否带 `/v1`，例如 `https://api.lucoo.net/v1`。
...
2. 使用 Lucoo 中转站 API Key，并到 [https://api.lucoo.net/console/topup](https://api.lucoo.net/console/topup) 充值。
...
| Base URL | `https://api.lucoo.net/v1` 或 `https://apicc.lucoo.net/v1` |
...
- 购买或充值后，到 [https://api.lucoo.net/console/topup](https://api.lucoo.net/console/topup) 完成兑换或充值确认。
